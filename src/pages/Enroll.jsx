...
Резултат, който впечатлява.`
  },
  {
    ...
    image_url: "https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/697ccaab3e4993397f9cee62/fa1312ba1_attO0HSrdtIgmvZjcIGW5OHzCiwuDtzIMapjbzRHgMEuF4.jpg",
    max_students: 2,
    description: `Надграждащо обучение по комбиниран маникюрПрецизност. Контрол. Съвършен резултат.Продължителност: 2 дниТова надграждащо обучение е създадено за маникюристи, които искат да усъвършенстват техниката си, да работят по-чисто, по-безопасно и с по-дълготраен резултат. Курсът е фокусиран върху детайла, правилния подбор на инструменти и контрола във всяка стъпка от работния процес.Ако вече работите с комбиниран маникюр, но търсите повече увереност, по-малко грешки и по-високо качество — това обучение е за вас.⸻Какво ще усвоите:Техника и контрол• Задълбочен анализ на комбинирания маникюр• Правилен подбор и използване на фрези• Контрол на натиск, ъгъл и скорост• Безопасна и ефективна работа с електрическа пила• Работа без порязвания и без изтъняване на плочкатаРабота с кутикулата – професионално ниво• Дълбока и прецизна обработка на кутикулата• Чиста линия без накъсване и травми• Подготовка за дълбоко лакиране под кутикул• Техники за минимално израстване и дълготраен ефектЧесто срещани грешки и тяхното коригиране• Защо резултатът не е чист• Как да избегнете напуквания и зачервявания• Работа при проблемна кожа и чувствителни клиенти• Анализ и корекция на индивидуалните грешки на курсистите⸻Практика и резултатОбучението е силно практическо и насочено към реалната работа в салон. Работи се стъпка по стъпка с постоянна обратна връзка и индивидуален подход.След обучението ще:✔ работите по-бързо и по-чисто✔ имате по-добър контрол и сигурност✔ постигате професионален и дълготраен резултат⸻За кого е подходящо обучението?• Маникюристи с базови познания по комбиниран маникюр• Професионалисти, които искат по-високо ниво на работа• Хора, които търсят усъвършенстване, а не просто сертификат⸻Това обучение не добавя просто техника – то променя начина ви на работа.Два дни.Фокус върху детайла.Резултат, който се вижда и усеща.`
  }
];
