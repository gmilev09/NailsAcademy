      ...
      <section className="pt-32 pb-16 px-6">
        <div className="container mx-auto max-w-4xl">
          ...
          >
            ...
            <p>
              Нашият уебсайт може да съдържа услуги от трети страни, които задават свои собствени бисквитки. Тези доставчици включват:
            </p>
            <ul>
              <li><strong>Stripe</strong> — за обработка на онлайн плащания. Stripe използва бисквитки за предотвратяване на измами и за сигурността на транзакциите.</li>
              <li><strong>Supabase</strong> — за управление на потребителски акаунти и данни. Използва бисквитки за автентикация на сесиите.</li>
              <li><strong>Vercel</strong> — за аналитика на уеб трафика.</li>
            </ul>
            <p>
              Ние нямаме контрол върху бисквитките, поставени от тези трети страни. Препоръчваме Ви да прегледате техните собствени политики за поверителност и бисквитки за повече информация.
            </p>
            ...
            <h2>5. Срок на съхранение на бисквитките</h2>
            <p>
            ...
            <h2>6. Промени в тази политика</h2>
            <p>
