        ...
        <div className="relative z-10 grid items-start gap-10 lg:grid-cols-[1.1fr_0.95fr] lg:gap-14">
          ...
          >
            ...
            <p className="mb-10 max-w-3xl text-lg leading-relaxed text-slate-600 md:text-xl">
              В ARTAYA Nails Academy не просто преподаваме техники за маникюр – ние изграждаме кариери. Нашите цялостни програми съчетават теория, практика и бизнес умения, за да ви подготвим за успех в бюти индустрията.
            </p>
