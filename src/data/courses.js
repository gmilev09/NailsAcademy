// NOTE: Курсове 1–3 са вербатим от репозиторито. Курс 4 е със съкратено описание
// (оригиналът е по-дълъг) — виж TODO в края за пълния файл.
...
Работим в групи до 4 курсисти, а за желаещите организираме и индивидуални обучения с изцяло персонализирана програма. Независимо от формата, подходът към всеки курсист е индивидуален - според темпото, нивото и целите му.
Графикът е гъвкав.
...
Резултат, който впечатлява.`,
  },
  {
    ...
    // TODO: Пълното описание е в оригиналния src/data/courses.js (файлът е 17KB)
    description: `Надграждащ курс: Работа с гел, корекции и усъвършенстване на техниката

Тънкости. Контрол. Съвършена архитектура.

Този курс е предназначен за маникюристи, които вече работят с гел и искат да издигнат техниката си до професионално ниво. Фокусът е върху корекциите, правилната архитектура и уверената работа при различни ситуации от салонната практика.

Какво ще усвоите:
• Анализ и корекция на архитектурата
• Изграждане и укрепване с гел
• Корекции след израстване
• Работа със сложни случаи и проблемни нокти
• Често срещани грешки и как да ги избегнем

Практическа част
Обучението е практически насочено, с индивидуален подход и детайлен разбор на всяка стъпка от процеса.
