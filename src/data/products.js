export const shopProducts = [
  {
    ...
    description: `Професионална електрическа пила Champion-3 - 65W / до 35 000 оборота

Професионалната електрическа пила Champion-3 е висок клас оборудване, създадено за маникюристи, които търсят мощност, прецизност и надеждност в ежедневната си работа. Подходяща както за салонна употреба, така и за напреднали специалисти, тя осигурява максимален контрол и комфорт при работа с естествени и изкуствени нокти.

Основни характеристики:

• Мощност: 65W - стабилна и постоянна работа без загуба на сила
• Обороти: до 35 000 RPM - висока производителност и бързина
• Плавно регулиране на скоростта
• Въртене в двете посоки (ляво/дясно)
• Максимален въртящ момент за ефективна работа без вибрации
• Стандартен размер на накрайниците: 2.35 мм
• Ергономична ръкохватка 

Предимства:

• Изключително тиха и гладка работа
• Минимални вибрации - по-голям комфорт и контрол
• Идеална за сваляне на гел, акрил и изграждане
• Компактен дизайн - удобна за работа и съхранение
• Възможност за управление с педал


Champion-3 е инвестиция в качество, скорост и прецизност - инструмент, който улеснява работата и повишава нивото на услугите Ви.`
  },
  {
    id: "2",
    name: "LED/UV лампа",
...
Това е незаменим инструмент за всеки маникюрист, който държи на чистотата, комфорта и професионалното ниво на услугите си.`
  ...
  },
  {
  ...
  },
   {
    ...
    category: "електроуреди",
    in_stock: true,
    image_url: "https://ae01.alicdn.com/kf/Se3a4224d204546dbac1af78385d2a6fcP.jpg?width=800&height=800&hash=1600",
    description: `Професионална електрическа пила Champion-3 - 65W / до 50 000 оборота
...
• Мощност: 65W - стабилна и постоянна работа без загуба на сила
• Обороти: до 50 000 RPM - висока производителност и бързина
• Плавно регулиране на скоростта
• Въртене в двете посоки (ляво/дясно)
• Максимален въртящ момент за ефективна работа без вибрации
• Стандартен размер на накрайниците: 2.35 мм
